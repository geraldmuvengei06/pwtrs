...
<template>
    ...
    <div class="bg-gradient-to-br from-[#F2F8FC]/80 to-[#FEF6F4]/80 border-b-2 backdrop-blur sticky top-0 z-50">
        <div class="hidden md:flex navbar custom-nav container mx-auto">
            <div class="navbar-start">
                <div class="dropdown">
                    ...
                    <ul tabindex="0"
                        class="menu dropdown-content mt-3 z-[1] p-2 shadow bg-[#F5F6FC] text-neutral rounded-box">
                        ...
                        <details v-else class="dropdown">
                            ...
                            <ul tabindex="0" class="p-2 w-80 overflow-y-scroll shadow">
                                ...
                                <ContentList path="/services" v-slot="{ list }">
                                    <NuxtLink v-for="service in list" :key="service?._path" :to="service?._path"
