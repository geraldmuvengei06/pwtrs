        ...
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-4 sm:p-6 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                <div class="flex gap-2">
                    ...
                    <button @click="goTo(`${home_url}`)" class="btn btn-secondary btn-outline ">Dashboard</button>
                </div>
            </div>
        </nav>
                ...
                <div class="mt-6 flow-root">
                    <div class="-my-6 divide-y divide-gray-500/10">
                        ...
                        <div class="py-6">
                            <div class="flex gap-2">
                                <button @click="goTo(`${order_url}`)" class="btn btn-primary">Order Now</button>
                                <button @click="goTo(`${home_url}`)"
                                    class="btn btn-secondary btn-outline ">Dashboard</button>
                            </div>
                        </div>
                    </div>
                </div>
