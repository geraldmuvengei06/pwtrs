...
<template>
  <div
    ...
    :class="classnames || 'justify-between md:justify-center'"
  >
    <div
      class="flex items-center justify-center sm:justify-start flex-row rounded-lg"
    >
      <div class="w-24">
        <NuxtImg alt="reviewsio" id="nuxt-img" src="/img/reviewsio.png" />
      </div>
    ...
    >
      <div class="w-24">
        <NuxtImg alt="sitejabber" id="nuxt-img" src="/img/sitejabber.png" />
      </div>
      <p class="text-base sm:text-lg w-1/4 flex flex-row items-center">
        <span
          class="pi pi-star-fill text-orange-400 text-base sm:text-lg"
