...
<template>
    <div class="shadow">
        <div class="container flex flex-row justify-between items-center">
            <img src="/favicon.ico" />
            <NavigationMenu class="py-4 hidden sm:flex">
                <NavigationMenuList class="text-right">
                    <NavigationMenuItem>
                    ...
                    <NavigationMenuItem>
                        <NavigationMenuTrigger class="bg-transparent">Components</NavigationMenuTrigger>
                        <NavigationMenuContent>
                    ...
                    <NavigationMenuItem>
                        <NavigationMenuLink  class="bg-transparent" href="/docs" :class="navigationMenuTriggerStyle()">
                            Documentation
                        </NavigationMenuLink>
                    </NavigationMenuItem>
                    <NavigationMenuItem>
                        <UiButton class="border border-primary bg-transparent text-primary hover:shadow hover:shadow-primary">
                            Sign In
                        </UiButton>
                    </NavigationMenuItem>
