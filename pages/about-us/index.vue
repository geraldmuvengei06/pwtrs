...
<template>
    ...
    <div class="container mx-auto max-w-4xl py-12 px-4">
        <article class="prose prose-slate  max-w-3xl mx-auto">
            ...
            <p>Fortunately, our research paper writing service, proswriters, boasts a team of seasoned writers ready
                to
            ...
            <p>Behind our <a>custom research paper writing service</a> are
                ...
                of them have gone through proswriters testing for the best result guarantee. Our authors are ready to
                share
