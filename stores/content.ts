...
export const contentStore = defineStore("content", () => {
    ...
    const page_content = {
        "About Us": {
            ...
            title: `Welcome to ${site_name}: Your Premier Nursing Essay Service`,
            subtitle:
        ...
        "How It Works": {
            ...
            title: "Navigating Excellence: The ${site_name} Way",
            subtitle:
        ...
        Samples: {
            ...
            subtitle:
                "Discover Quality in Every 'Write My Essay for Me' and 'Write My Paper'",
    ...
    const experts = [
        {
            ...
            "categories": ["Nursing", "Healthcare", "Essays", "Business", "History", "English", "Mathematics", "Science"],
        ...
        },
        {
            ...
            "categories": ["English", "History", "Business", "Nursing", "Healthcare", "Psychology", "Marketing"],
        ...
        },
        {
            ...
            "categories": ["Essays", "Nursing", "Business", "History", "Healthcare", "Economics", "Sociology"],
        ...
        },
        {
            ...
            "categories": ["Healthcare", "Business", "Nursing", "English", "Essays", "Computer Science", "Art"],
        ...
        },
        {
            ...
            "categories": ["History", "English", "Essays", "Business", "Nursing", "Education", "Music"],
        ...
        },
        {
            ...
            "categories": ["Physics", "Chemistry", "Mathematics", "Computer Science", "Engineering", "Art", "Biology"],
        ...
        },
        {
            ...
            "categories": ["Psychology", "Sociology", "Counseling", "Education", "Child Development", "Healthcare", "Business"],
        ...
        },
        {
            ...
            "categories": ["Marketing", "Public Relations", "Advertising", "Graphic Design", "Web Development", "Business", "Communication"],
        ...
        },
        {
            ...
            "categories": ["Social Work", "Counseling", "Psychology", "Sociology", "Education", "Healthcare", "Child Development"],
        ...
        },
        {
            ...
            "categories": ["Engineering", "Computer Science", "Mathematics", "Physics", "Art", "Biology", "Chemistry"],
        ...
        },
        {
            ...
            "categories": ["Art", "Graphic Design", "Web Development", "Digital Marketing", "Photography", "Advertising", "Business"],
        ...
        },
        {
            ...
            "categories": ["Environmental Science", "Sustainability", "Renewable Energy", "Climate Change", "Green Technology", "Engineering", "Economics"],
    ...
    const why_us = [
        { "title": "Unwavering Originality", "description": "Our dedicated writers craft every essay from scratch, ensuring impeccable authenticity." },
        { "title": "24/7 Support", "description": "Reach out to our support agents day or night, saying 'write my essays for me,' and receive immediate assistance." },
        { "title": "Fortified Anonymity", "description": "Pay for essays without a trace. Our top-level encryption and secure payment gateway safeguard your personal data, even from your paper writer." },
        { "title": "Expert Writers in Every Field", "description": "Our team comprises online expert writers with diverse academic backgrounds, matching your task with expertise." },
        { "title": "Punctuality is Paramount", "description": "We ensure on-time delivery with a quick turnaround for 'online nursing papers' or 'write my paper for me' requests." },
        { "title": "Quality Meets Affordability", "description": "With competitive pricing and budget-friendly access to exceptional essay services, we offer quality without breaking the bank." }
    ]
